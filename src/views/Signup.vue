            ...
            <v-card class="elevation-12">
              ...
              <v-alert	:value="error"	type="warning">
                ...
                <v-form v-model="valid">
                  ...
                  <v-text-field prepend-icon="email" name="login" label="Эл. адрес" type="email" required v-model="email" :rules="emailRules"></v-text-field>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="primary" @click.prevent="signup" :disabled="processing || !valid">Продолжить</v-btn>
              </v-card-actions>
            </v-card>
          </v-flex>
        </v-layout>
